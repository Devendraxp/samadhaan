...
export default function MessLayout({ children }: { children: ReactNode }) {
  ...
  const links: DashboardLink[] = [
    { href: "/dashboard/mess", name: "Home", icon: <Home className="size-4" /> },
    { href: "/dashboard/mess/notifications", name: "Notifications", icon: <Bell className="size-4" /> },
];
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      <DashboardSidebar user={{ name: user.name, role: "mess", image: user.image || staffIcon }} links={links} />
