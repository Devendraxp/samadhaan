...
export default function NewNotificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fd.append("domain", domain); // matches allowed values
      fd.append("type", type); // ALERT | UPDATE | ANNOUNCEMENT
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      ...
      <h1 className="text-xl font-semibold mb-4">New Notification</h1>
