...
export default function InternetNotificationDetailPage() {
      ...
      try {
        ...
        if (data && mounted) {
          if (data.domain?.toUpperCase() !== DOMAIN) {
            ...
            router.replace("/dashboard/internet/notifications");
            return;
          }
          setItem(data);
      ...
      {loading ? (
        ...
        <div className="border rounded p-6 shadow-sm">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link
              href={`/dashboard/internet/notifications/${item.id}/edit`}
          ...
          <div className="mt-6">
            <Link
              href="/dashboard/internet/notifications"
