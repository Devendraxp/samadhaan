...
export default function WaterNotificationsPage() {
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Link
          href="/dashboard/water/notifications/new"
          ...
          {items.map((n) => (
            <div key={n.id} className="border rounded p-4 flex justify-between gap-4">
              ...
              <div className="flex flex-col gap-2">
                <Link
                  href={`/dashboard/water/notifications/${n.id}`}
                  className="px-3 py-1.5 text-xs rounded bg-zinc-100 hover:bg-zinc-200"
                >
                  View
                </Link>
                <Link
                  href={`/dashboard/water/notifications/${n.id}/edit`}
                  className="px-3 py-1.5 text-xs rounded bg-zinc-100 hover:bg-zinc-200"
                >
                  Edit
                </Link>
